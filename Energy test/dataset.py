...
class DataComparator:
    ...
    Attributes:
         set_reference(DataSet): data set of points from known distribution
         set_experimental(DataSet): data set of points from unknown distribution - i.e. from experiment
    """
    ...
    def __init__(self, set_reference, set_experimental):
        ...
        self._temp_set_f = DataSet(temp_len)
        self._temp_set_g = DataSet(len(set_reference) - temp_len)
